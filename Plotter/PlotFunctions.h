...
// -------------------------------------------------------------------------------------
void StampLabel( const std::string & approvaltext = "Simulation", float lumi=140., float x=0.14, float y=0.84, float textsize=0.045) {
  // Usage:  StampLabel("Internal", 126.5, 0.12, 0.75);
  ...
  label_cms.DrawLatex( x, y, "DarkQuest" );
  ...
  label_approvaltext.DrawLatex( x+0.17, y, approvaltext.c_str() ); 
